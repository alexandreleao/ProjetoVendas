...
public class Frmfuncionarios extends javax.swing.JFrame {
    ...
    private void tabelaFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFuncionariosMouseClicked
      ...
      txtcodigo.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),0).toString());
      ...
      txtsenha.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),5).toString());
      txtcargo.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),6).toString());
      cbnivel.setSelectedItem((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),7).toString());
      txttelefone.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),8).toString());
      txtcelular.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),9).toString());
      txtcep.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),10).toString());
      txtendereco.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),11).toString());
      txtnumero.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),12).toString());
      txtcomplemento.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),13).toString());
      txtbairro.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),14).toString());
      txtcidade.setText((String)tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(),15).toString());
