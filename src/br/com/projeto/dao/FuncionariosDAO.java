...
public class FuncionariosDAO {
    ...
    public void cadastrarFuncionarios(Funcionarios obj){
        try {
            ...
            + "cep,endereco,numero,complemento,bairro,cidade,estado)Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    //Metodo Listar todos os Funciona´rios
    ...
    //Metodo consulta Funcionarios por nome
     ...
     //Metodo buscarfuncionariosPorNome
        ...
        try {
            ...
            if(rs.next()){
               ...
               //Caso o usuario seja do tipo limitado
                ...
                tela.menuposicaodia.setVisible(false);
